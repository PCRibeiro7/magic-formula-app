...
export const fetchAllStocks = async () => {
    try {
        ...
        const stockResponseParsed = await stocksResponse.json();
        return stockResponseParsed.list;
    } catch (error) {
        console.log(error)
    }
};
